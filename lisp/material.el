;;; Material-theme.el --- Theme

;; Copyright (C) 2010- 2018 , Henry MATHEISEN
...
;;; Commentary: VSCode Material Theme
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'Material-theme
	...
	`(cursor ((,class (:background ,bg3))))
        ...
        `(mode-line ((,class (:box (:line-width 1 :color nil) :bold t :foreground ,fg1 :background ,bg2))))
