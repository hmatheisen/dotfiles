...
let g:moonflyCursorColor = get(g:, 'moonflyCursorColor', 1)
...
" floating windows).
let g:moonflyNormalFloat = get(g:, 'moonflyNormalFloat', 1)
...
exec 'highlight StatusLine ctermbg=' . s:white.term . '  ctermfg=' . s:black.term . ' cterm=none guibg=' . s:white.hex . ' guifg=' . s:black.hex . ' gui=none'
